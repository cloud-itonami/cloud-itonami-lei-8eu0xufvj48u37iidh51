...
This repository archives the publicly published Terms of Use of Casella
Waste Systems, Inc., per ADR-2607110300 -- a read-only reference archive.
As part of a third 10-repo validation batch extending the
...
- **Company**: Casella Waste Systems, Inc., LEI 8EU0XUFVJ48U37IIDH51,
  website `https://www.casella.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.casella.com/terms`,
...
proves the actor pattern holds for a second, independently different
